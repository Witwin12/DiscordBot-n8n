...
1.  **Webhook Node:**
    * **HTTP Method:** `POST`
    * **Path:** ตั้งชื่อตามต้องการ (เช่น `discord-bot`)
    * *นำ Production URL ที่ได้จาก n8n ไปใส่ใน Discord Developer Portal*
2.  **Message a model Node:**
    * เชื่อมต่อ Credentials ของ AI Provider (เช่น Google Gemini API หรือ OpenAI)
    * เลือก Model ที่ต้องการใช้งาน
3.  **Discord Node:**
    * เชื่อมต่อด้วย **Bot Token**
    * เลือก Action เป็น `Send Message`
